...
/**
 * Name: FXMLDocumentController Date: 3.27.2018
 *
 * @author danielcender Abstract: This file provides the "controller" aspect of
 * the MVC pattern followed by JavaFX. It handles the logic of PamperedPet
 */
public class FXMLDocumentController implements Initializable
{
    ...
    @FXML
    private ToggleGroup grpShots;
    @FXML
    private ToggleGroup grpSuite;
    @FXML
    private Pane grpServices;
    @FXML
    private Label lblDoses;
