...
public class Employee
{
        ...
        public short getDepartmentNbr()             { return departmentNbr; }
        public void setDepartmentNbr(short value)   { departmentNbr = value; }
        ...
        public boolean parseCSV(String inputLine)
        {
            ...
            try
            {
                ...
                departmentNbr = Short.parseShort(splitFields[1]);
                lastName = splitFields[2];
                firstName = splitFields[3];
                System.out.println("Got to 4 elements.");
                ...
                System.out.println("Got to 8 elements");
                ...
                System.out.println("Parsed 14 elements");
                ...
                System.out.println("Parsed all of input line.");
                isSuccessful = true;
            }
            catch (Exception err)
            {
        ...
        public void initialize() {
            ...
            taxMaritalStatus = 'A';
            nbrExemptions = 0;
            stateWithholdingPercentage = 0.0f;
            ytdGrossEarnings = 0.0f;
            ytdFederalTaxes = 0.0f;
            ytdSocialSecurityTaxes = 0.0f;
            ytdMedicareTaxes = 0.0f;
            ytdStateTaxes = 0.0f;
            ytdDeductions = 0;
            deductionCodes[0] = 'A';
            deductionCodes[1] = 'A';
            deductionCodes[2] = 'A';
            deductionValues[0] = 0.0f;
            deductionValues[1] = 0.0f;
            deductionValues[2] = 0.0f;
        }
}